...
// TODO menú no debe extender de ArchivoServicios
	...
	public void seleccionOpcion(List<String> pOpcionesMenu) {
		...
		do {
			...
			case 5:
				...
				if (opcion == 1) {
					// TODO acá se instancia ExportadorTxt y se llama al método exportar(String, List<Cliente>)
					archivoServicios.exportarTxt("boleta.txt", listaClientes);
					Utilidad.stopAndContinue();
					; // TODO sobra
				} else {
					// TODO acá se instancia ExportadorCSV y se llama al método exportar(String, List<Cliente>)
